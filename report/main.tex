...
\usepackage[a4paper, top=0.15in, bottom=0.6in, left=0.6in, right=0.6in]{geometry}
...
CNN* and ViT* denote the models with the highest test classification accuracies.

\begin{figure}[H]
   \centering
   \includegraphics[width=1\textwidth]{/home/jake/Personal/SeeingTheUnknot/report/acc-by-nc.png}
\end{figure}
...
Saliency maps for knot diagrams in $\mathcal{D}_{\mathrm{test}}$ from the CNN with the highest test accuracy, CNN*.
...
Saliency maps for knot diagrams in $\mathcal{D}_{\mathrm{test}}$ from the ViT with the highest test accuracy, ViT*.
