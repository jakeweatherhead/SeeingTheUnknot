...
\noindent
The same CNN and ViT used in our initial study were fine-tuned on a new dataset $\mathcal{D}$, where:\\
...
\noindent
Each split included knots with $n$ crossings, where $n \in \{20, \,21, \ldots, \,35\}$.
For every $n$, the number of diagrams per split was identical, with an equal 
number of unknots and non-trivial knots.

\begin{figure}[H]
   \centering
   \includegraphics[width=1\textwidth]{tikz/NOV-MON-10/example-diagrams.png}
