...
\text{where } \; \forall s \in S, \;\, \mathcal{D}_{s} \in \; \mathcal{U}_s \, \cup \, \mathcal{K}_s \; \text{ and } \; |\mathcal{U}_s| = |\mathcal{K}_s|. \\[0.5em]
\end{gathered}
\]
...
of CNN* is 97.673\%; the test accuracy of ViT* is 89.075\%.
