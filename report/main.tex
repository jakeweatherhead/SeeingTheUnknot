...
$\mathcal{K}$ diagrams partitioned into three disjoint data splits $S := \{$train, test, val$\}$, where:\\
...
\noindent
Each split contained knots for every crossing count $n \in N := \{20, \, 21, \, \ldots \,, \,35 \}$.
