...
\noindent
The CNN (88M params) and ViT (86M params) were fine-tuned on a new dataset $\mathcal{D}$ comprising unknot and non-trivial knot
diagrams ($\mathcal{U}$ and $\mathcal{K}$) partitioned into three disjoint splits $S = \{\mathcal{D}_{\mathrm{train}}, 
